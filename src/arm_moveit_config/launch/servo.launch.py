...
# Hardware-facing variant of servo_sim.launch.py. This package carries no
# driver of its own: bring your own ros2_control hardware_interface plugin and
# pass it via hardware_plugin:=<vendor>/<PluginClass>.
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "use_mock_hardware",
            default_value="false",
            description="Use mock hardware (simulation) instead of a real hardware plugin",
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
            "hardware_plugin",
            default_value="dynamixel_node/DynamixelServos",
            description=(
